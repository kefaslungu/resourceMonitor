...
* NVDA+Shift+E: fornisce informazioni sulla quantità di ram utilizzata, sul
  carico medio della cpu e sulla batteria, se disponibili.
...
* NVDA+Shift+3: riporta la dimensione totale e la percentuale di utilizzo
  delle unità locali e rimovibili.
...
Se si dispone di NVDA 2013.3 o superiore, è possibile modificare tutti i
