...
* Автори: Alex Hall, Joseph Lee, beqa gozalishvili, Tuukka Ojala и други
  сътрудници на NVDA
...
* Ако има интензивна дейност на диска, например копиране на големи файлове,
  ...
  диска.
* Поддръжката на тази добавка за Windows XP ще приключи на 31 декември 2017
  г. Поддръжката за Windows Server 2003 и Windows Vista ще приключи на 30
  юни 2018 г.
