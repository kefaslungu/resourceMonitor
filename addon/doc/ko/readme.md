...
이전 리소스 모니터 버전 사용자들을 위해 NVDA+Shift+1부터 NVDA+Shift+7까지의 리소스 정보 명령도 사용할 수 있습니다(호환 모드로 남김):
...
* 윈도우 버전 알림에 포함된 "AMD64"는 프로세서 이름이 아닌 Intel 및 AMD 64비트 프로세서 아키텍처(processor architecture)를 의미합니다.
